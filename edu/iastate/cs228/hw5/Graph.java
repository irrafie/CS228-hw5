package edu.iastate.edu.cs228.hw5;
...
public class Graph {
   ...
   */
  public void addEdge(int fromIdx, int toIdx, int index, String word) throws IndexOutOfBoundsException,
  ...
  public String toString() {
    ...
    build.append("edu.iastate.edu.cs228.hw5.Graph with ")
